    ...
    return (
        <div className='flex justify-center items-center font-light'>
            ...
            <div
                ...
                className="flex rounded-full border-[3.5px] border-[#0000] [background:padding-box_var(--bg-color),border-box_var(--border-color)] mr-4"
            >
            ...
            <div>
                ...
                <div className='flex justify-center items-center'>
                    <span className='mx-5 text-[27px]'>CHEUNG Tsz Lai</span>
                ...
                <div className='flex items-center text-[16px] my-4'>
                    <span className='mx-5'><span className='font-bold'>2</span> Yrs Exp</span>
                    <span className='mx-5'><span className='font-bold'>10+</span> Projects</span>
                    <span className='mx-5'><span className='font-bold'>10+</span> Skills</span>
                </div>
                {/* col-3 */}
                <div className='flex flex-col text-[16px]'>
                    <span className='mx-5 font-bold'>Bosco</span>
                    <span className='mx-5 text-[#9A9A9A]'>Solutions Developer</span>
                    <span className='mx-5 text-[#9A9A9A]'>Web / App Design + Development, Photo / Video Editing</span>
                </div>
                {/* col-4 */}
                <div className='flex items-center text-[16px] my-4'>
                    <button className='mx-5'>
